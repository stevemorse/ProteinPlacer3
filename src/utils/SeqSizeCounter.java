...
public class SeqSizeCounter {
	...
	public static void printSizes() {
		...
		try {
			...
			printWriter.println("1000-1100" + "," + size1000bucket);
			printWriter.println("1100-1200" + "," + size1100bucket);
			printWriter.println("1200-1300" + "," + size1200bucket);
			printWriter.println("1300-1400" + "," + size1300bucket);
			printWriter.println("1400-1500" + "," + size1400bucket);
			printWriter.println("1500-1600" + "," + size1500bucket);
			printWriter.println("1600-1700" + "," + size1600bucket);
			printWriter.println("1700-1800" + "," + size1700bucket);
			printWriter.println("1800-1900" + "," + size1800bucket);
			printWriter.println("1900-2000" + "," + size1900bucket);
			printWriter.println("2000-3000" + "," + size1900bucket);
