 ...
 */
public class SingleGoAnchorRunnableFF extends PriorityRunnable{
	...
	public SingleGoAnchorRunnableFF(Protein currentProtein, String url, String currentGoAnchorString, 
	...
	public void run () throws org.openqa.selenium.WebDriverException{
		...
		final String geckoPathStr = "/home/steve/eclipse-workspace/geckodriver";
