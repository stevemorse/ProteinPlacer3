 ...
 * for this accession.
 */
public class SingleAndhorRunnableFF extends PriorityRunnable{
	...
	public SingleAndhorRunnableFF(Protein currentProtien, String accession, StringBuilder region, Map<String, String>GoAnnotationLocations, 
...
System.out.println("submit input text element with data: " + inputTextFeildElement.getAttribute("value"));
